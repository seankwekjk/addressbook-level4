...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDAY_AMY = "01/12/1970";
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY
            + "01/dec/2012"; //words not allowed for birthday
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withBirthday(VALID_BIRTHDAY_AMY).withSocial(VALID_URL_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withBirthday(VALID_BIRTHDAY_BOB).withSocial(VALID_URL_BOB)
    ...
    public static void showFirstPersonOnly(Model model) {
        ...
        model.updateFilteredPersonList(new AnyParticularContainsKeywordsPredicate(Arrays.asList(splitName[0])));
