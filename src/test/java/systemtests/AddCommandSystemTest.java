...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                ...
                + SOCIAL_DESC_AMY + TAG_DESC_FRIEND + " ";
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + BIRTHDAY_DESC_AMY + SOCIAL_DESC_AMY + TAG_DESC_FRIEND;
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + BIRTHDAY_DESC_AMY + SOCIAL_DESC_AMY + " " + PREFIX_TAG.getPrefix() + "friends";
        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_PERSON);
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                ...
                .withSocialMedia(VALID_URL_AMY).withTags(VALID_TAG_FRIEND).build();
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY)
                ...
                .withBirthday(VALID_BIRTHDAY_BOB).withSocialMedia(VALID_URL_AMY).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + BIRTHDAY_DESC_BOB + SOCIAL_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_BOB + ADDRESS_DESC_AMY
                + BIRTHDAY_DESC_BOB + SOCIAL_DESC_BOB + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB + NAME_DESC_BOB
                + TAG_DESC_HUSBAND + EMAIL_DESC_BOB + BIRTHDAY_DESC_BOB + SOCIAL_DESC_BOB;
        assertCommandSuccess(command, toAdd);
