...
* Email a contact by typing in the command `email` followed by the contact's name or index.
...
* Contacts can be starred in Contags based upon your preference to give priority in the list of
contacts.
