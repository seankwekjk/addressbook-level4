...
=== Viewing contacts with  birthdays on the current date: `listbirthday`
...
* `mail 1` +
Opens up mail application and the to field of the mail will be automatically filled in with the email address of the contact at the specified index.
