...
3. Fill in the subject and message field and hit send! Your mail will be successfully sent. Figure 5.12.1 below shows how your screen should look like after execution of the mail command if you set your default mail application to be the desktop mail on Windows.
