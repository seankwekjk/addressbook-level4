...
****
* Selects the person and loads either a Google Maps search of the person's specified address, or the person's specified social media link
...
* Emailing a person by typing in the command email followed by the contact's name or index.

* A reminder list that will pop up on the screen every time the user opens the application.

* A meeting scheduler, where users link to their calender application when they first install the application. +
...
* Contacts can be starred in the Contags Application based upon the user's preference to give priority in the list of
contacts.
