...
2. On the left panel, you will see a list of contacts with birthdays on the current day.
...
3. Fill in the subject and message field and hit send! Your mail will be successfully sent.
