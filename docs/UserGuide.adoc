...
This command lists all your contacts whose birthdays fall on the current date. The contacts are listed in order of the latest updated list.
...
3. Fill in the subject and message field and hit send!
