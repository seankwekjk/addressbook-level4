...
2.0 in which we hope to bring across as soon as possible. We project that our current application, as well as those that will be brought across in Version 2.0, will make Contags one of the most
