...
Letting users change the tag color to the color of their choice will make the application more user-friendly and customisable
for the user. Setting the color of each tag also allows them to sort their tags in their own way which lets them better use the colors
as another form of organisation.
