...
[discrete]
=== Use case: SMS Contact

*MSS*

1.  User requests to SMS a specific person in the Contags Application.
2.  Contags sends SMS to indicated person with message input from user.
+
Use case ends.
...
[none]
* 1a. Given Index is not Valid
+
** 1a1. Contags informs user that index is invalid, and prompts for another index.
Use case ends.
...
2.  Contags edits the contact particular and displays the updated particulars of the person.
+
Use case ends.
...
* 3c. Contags updates the selected contact.
+
Use case ends.
+
...
*MSS*
 ...
 2.  Contags searches through all contacts that have been tagged with the same tag, removes the tags from all these contacts and displays updated particulars of the contacts.
 +
 Use case ends.
...
+
Contags informs user that the number is not yet authorized on Twilio.

* 1b. Index given is invalid.
+
Contags informs user that the index given is invalid.
// end::smsContact[]
[discrete]
=== Use case: History
...
+
** 1a1. AddressBook informs user that contact cannot be found.
...
1. User requests to mail a contact by typing in mail command, followed by the index, title and message.
...
* 3a. User inputs invalid contact index.
+
** 3a1. Contags informs user that the input is not a valid contact index.
...
* 1a. Tag cannot be found.
+
** 1a1. Contags informs user that the tag does not exist.
