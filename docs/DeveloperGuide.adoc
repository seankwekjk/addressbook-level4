...
The sequence diagram for the listbirthday command is shown below in figure 4.4a.
...
The following sequence diagram (figure 4.7a) illustrates the execution of the `mail` command.
