...
The _Sequence Diagram (Figure 3.1.3a)_ below shows how the components interact for the scenario where the user issues the command `delete 1`.
...
* can save the Contags data in xml format and read it back.
...
|`* * *` |user |send an SMS message to any contact in the Contags Application
