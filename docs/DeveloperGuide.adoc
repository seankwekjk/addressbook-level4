...
|`* * *` |user |find a person with an incomplete name |find a person with an incomplete name |to find a person even if I cannot remember or spell the person's name correctly
